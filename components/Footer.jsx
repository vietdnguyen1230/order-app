...
const Footer = () => {
  ...
  return (
    <footer className='text-white bg-zinc-900 lg:grid lg:grid-cols-5 mt-20'>
      <aside className='hidden lg:relative lg:col-span-2 lg:block'>
        <Image
          className='absolute inset-0 object-cover w-full h-full'
          src='https://images.unsplash.com/photo-1593246049226-ded77bf90326?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735'
          alt=''
          layout='fill'
        />
      </aside>
          ...
          <div>
            ...
            >
              ...
              <h1 className='text-white pl-1'>
                {" "}
                VIERI <span className='text-[#d1411e]'>PIZZA</span>
              </h1>
            </div>
